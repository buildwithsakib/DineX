...
<head>
    ...
    <style>
        ...
        .basket-bounce { animation: bounce 1s infinite; }
...
<body class="bg-animated min-h-[100dvh] flex flex-col items-center justify-between py-6 px-4 text-white">
    ...
    <div class="text-center z-10 mt-4">
        ...
        <p class="text-gray-300 text-sm font-medium">Catch falling prizes before they hit the ground!</p>
    </div>

    <div class="z-10 my-8 text-center">
        <div class="text-7xl basket-bounce">🧺</div>
        <div class="flex justify-center gap-6 mt-6">
            <div class="text-5xl animate-bounce" style="animation-delay:0s">🎁</div>
    ...
    <div class="z-10 w-full max-w-sm text-center mb-4">
        <button id="actionBtn" onclick="play()" class="spin-btn w-full text-white font-black text-xl py-4 rounded-2xl flex items-center justify-center gap-3 tracking-wide">
            <i class="fa-solid fa-basket-shopping"></i> <span>CATCH NOW</span>
        </button>
    ...
    <script>
        ...
        async function play() {
            ...
            const btn = document.getElementById('actionBtn');
            btn.disabled = true;
            btn.innerHTML = '<i class="fa-solid fa-spinner fa-spin"></i> <span>CATCHING...</span>';
            ...
            setTimeout(async () => {
                try {
                    ...
                    isPlaying = false;
                    btn.innerHTML = '<i class="fa-solid fa-basket-shopping"></i> <span>CATCH NOW</span>';
                    updateDailyLockUI();
                }
            }, 1000);
        }
